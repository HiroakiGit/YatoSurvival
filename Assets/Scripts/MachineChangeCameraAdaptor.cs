...
/// </summary>
[ExecuteInEditMode]
public class MachineChangeCameraAdaptor : MonoBehaviour
{
    ...
    private void UpdateOrthographicSize()
    {
        ...
        {
            _camera.m_Lens.OrthographicSize = baseOrthographicSize;
        }
        else
        {
            _camera.m_Lens.OrthographicSize = baseOrthographicSize * (_currentAspect / baseAspect);
        }
    }
