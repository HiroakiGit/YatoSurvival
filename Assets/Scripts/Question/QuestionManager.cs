...
public class QuestionManager : MonoBehaviour
{
    ...
    private void ShowQuestion(Question question)
    {
        ...
        SEAudio.Instance.PlayOneShot(questionSoundClip, 0.3f);
    }
    ...
    private IEnumerator OnQuestionAnswered(bool isCorrect ,bool isHard)
    {
        ...
        if (isCorrect)
        {
            ...
            SEAudio.Instance.PlayOneShot(collectSoundClip, 0.5f);
        }
        else
        {
            //バツ
            MaruAndBatsuImage.sprite = MaruAndBatsuSprites[1];
            SEAudio.Instance.PlayOneShot(inCollectSoundClip, 0.5f);
        }
        ...
        //口惜し
        if (!isCorrect && isHard) SEAudio.Instance.PlayOneShot(kuchioshiSoundClip, 0.7f);
